 ...
 */
public class KatsunaKeyboardView extends View implements View.OnClickListener {
    ...
    private KatsunaKeyboardView mMiniKeyboard;
    ...
    public KatsunaKeyboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public KatsunaKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);

        mContext = context;

        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.KatsunaKeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.KatsunaKeyboardView_keyBackground:
                    mKeyBackground = a.getDrawable(attr);
                    break;
                case R.styleable.KatsunaKeyboardView_verticalCorrection:
                    mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
                    break;
                case R.styleable.KatsunaKeyboardView_keyPreviewLayout:
                    previewLayout = a.getResourceId(attr, 0);
                    break;
                case R.styleable.KatsunaKeyboardView_keyPreviewOffset:
                    mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
                    break;
                case R.styleable.KatsunaKeyboardView_keyPreviewHeight:
                    mPreviewHeight = a.getDimensionPixelSize(attr, 80);
                    break;
                case R.styleable.KatsunaKeyboardView_keyTextSize:
                    mKeyTextSize = a.getDimensionPixelSize(attr, 18);
                    break;
                case R.styleable.KatsunaKeyboardView_keyTextColor:
                    mKeyTextColor = a.getColor(attr, 0xFF000000);
                    break;
                case R.styleable.KatsunaKeyboardView_labelTextSize:
                    mLabelTextSize = a.getDimensionPixelSize(attr, 14);
                    break;
                case R.styleable.KatsunaKeyboardView_popupLayout:
                    mPopupLayout = a.getResourceId(attr, 0);
                    break;
                case R.styleable.KatsunaKeyboardView_shadowColor:
                    mShadowColor = a.getColor(attr, 0);
                    break;
                case R.styleable.KatsunaKeyboardView_shadowRadius:
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mKeyboard != null) {
            // TODO UNDO COMMENT AND BRING MORE AOSP CODE IN
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            final Drawable keyBackground = getBackgroundDrawable(key);
            if (keyBackground != null) {
                setBackgroundDrawableState(keyBackground, key);
    ...
    private Drawable getBackgroundDrawable(Keyboard.Key key) {
        ...
        switch (key.codes[0]) {
            ...
            case Constants.KEYCODE_SYMBOLS:
            case Constants.KEYCODE_SHIFT:
            case Constants.KEYCODE_DELETE:
                output = ContextCompat.getDrawable(mContext, R.drawable.rounded_corners);
                break;
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = (KatsunaKeyboardView) mMiniKeyboardContainer.findViewById(
                        R.id.keyboardView);
            }
            getLocationInWindow(mCoordinates);
